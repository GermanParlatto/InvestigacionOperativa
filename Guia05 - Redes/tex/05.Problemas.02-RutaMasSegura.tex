...
Si bien la red anterior representa las posibilidaes de no ser detenido, para poder resolverlo como un problema de ruta más corta calculamos el opuesto del logaritmo decimal de los valores, de manera de buscar minimizar las posibilidades de ser detenidos, como se ve en la siguiente red:
...
\insertarTabla{01.02.01.tex}{Iteraciónes}
